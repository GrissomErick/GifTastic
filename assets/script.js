//==============================================================================
// GOALS FOR THIS EXECERSISE
// 1. COMMENT EVERYTHING NEED MORE PRACTICE
// 2. NEXT PROJECT USE CSS GRID - JUST FINISHED TUTORIAL; AWESOME; THE FUTURE OF MARKUP FOR SURE
// 3. USE THE SNOW DAY TO CATCH UP
//==============================================================================
...
$(document).ready(function() {
    ...
    $(document).on("click", ".button-topic", function(event) {
        ...
        $.get( // GIFY API URL 
            "https://api.giphy.com/v1/gifs/search?api_key=F3qeKgXieVJbx9zdDcW1yUUztTPUbrSu&q=" + buttonValue + "&limit=10&offset=0&rating=R&lang=en"
